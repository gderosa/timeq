...
\veryHuge \color{NavyBlue} \textbf{It's $\ket{1}$ o'clock --- Quantum Relational Time} \color{Black}\\ % Title
\Huge\textit{Overcoming Pauli's objection}\\[2cm] % Subtitle
...
\includegraphics[width=20cm]{ucc_logo.png}\\  %% TODO: svg?
\end{minipage}
