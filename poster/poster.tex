...
%
Within this formalism, unitary {evolution} {emerges} in terms of \emph{entanglement} between non-interacting subsystems
of a “universe” in a stationary state.
%
A subsystem, with the required properties,  can be identified as a “clock” for the “rest”
of such universe \cite{Lloyd:Time} (or isolated system).
%
In the present work \cite{DeRosaMSc},
{discrete} clock examples are implemented,
...
\begin{center}
  ...
  \captionof{figure}{
    \color{Green}
    Normalization loss and detection probability.
  }
\end{center}
