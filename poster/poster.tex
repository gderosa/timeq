...
The idea of time a quantum observable,
with an associated self-adjoint operator in a Hilbert space,
was first objected to by Wolfgang Pauli \cite{PauliFootnote}.
%
...
\end{center}
\begin{center}\vspace{1cm}
  \includegraphics[width=.25\textwidth]{3ldetect/PWSpaceTimeFit_side.pdf}\includegraphics[width=.25\textwidth]{3ldetect/PWSpaceTimeFit_top.pdf}
  \captionof{figure}{
    \color{Green}
    Discrete Page--Wootters results (points)
    compared to continuous
    Schr\"{o}dinger
    evolution (continuous lines). Complex values.  3-D plot shown on two angles.
  }
\end{center}
