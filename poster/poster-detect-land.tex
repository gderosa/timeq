...
\usepackage[b1paper,top=2cm,right=2cm,bottom=2.5cm,left=2cm]{geometry}
...
\includegraphics[width=0.66\linewidth]{ucc_logo.pdf}\\[0.0cm]
\end{minipage}%
...
\begin{equation}\large\label{eq:complexpot}
...
\begin{equation}\large\label{eq:energyfix}
