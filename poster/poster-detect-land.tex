...
\usepackage[b1paper,top=1cm,right=2cm,bottom=2cm,left=2cm]{geometry}


\usepackage{multicol} % This is so we can have multiple columns of text side-by-side
\columnsep=1in % This is the amount of white space between the columns in the poster
\columnseprule=0.025pt % This is the thickness of the black line between the columns in the poster
...
\usepackage[safeinputenc,style=authoryear-icomp,doi=false,url=false,backend=biber]{biblatex}
...
is ``energy-shifted'' \parencite{Lloyd:Time}:
...
Finally, as shown in \parencite{RuschhauptAbsorption}, the detection probability amplitude
in time
...
\vspace{0.5cm}
\begin{center}
  \includegraphics[width=0.6\linewidth,height=0.37\linewidth]{2ldetect/qutrit-lossy.png}
  \captionof{figure}{
    \color{Green}
...
\vspace{0.5cm}
\begin{center}
  \includegraphics[width=0.6\linewidth,height=0.37\linewidth]{2ldetect/qutrit-detect-both.png}
  \captionof{figure}{
    \color{Green}
    \emph{Discrete points:} time-of-arrival at $\ket{2}$ per (discrete) PaW model,
    using conditional definition of \parencite{Maccone:QMOT} and no complex potential.
    \emph{Continuous line:}
    Detector model with complex potential (as in \parencite{RuschhauptAbsorption}),
