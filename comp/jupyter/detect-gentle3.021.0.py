...
# %%
# init_printing()  # this is numeric only
...
for (vertical_angle, horizontal_angle, height, width) in (10, -120, 15, 13), (45, -45, 13, 13):
    fig = plt.figure(figsize=(width, height))
