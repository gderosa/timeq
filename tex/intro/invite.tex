...
\begin{figure}[h]
  ...
  \caption[The \emph{Four Faced Liar} -- Shandon Bells Tower, Cork]{
    The \emph{Four Faced Liar} (Shandon Bells Tower, St. Anne's Church, Cork)
    famously
    indicates four slightly different hours on its clocks.
    This is likely not due to a quantum effect.
  }
\end{figure}
