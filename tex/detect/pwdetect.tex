...
Switching to the frequency (and, therefore, energy) domain,
the discrete Fourier transform yields another proper vector
$\Dket{\tilde{\Phi}}$ of $\pwspace$:
\begin{equation}
  \Dket{\tilde{\Phi}} = F \ox \idop_s \dket{\Psi} \, \text{.}
\end{equation}
This vector's numerical components give the probability amplitude
relative to eigenstates of the frequency operator $\hat{\Omega}$