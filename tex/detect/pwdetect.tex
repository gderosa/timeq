...
The probability of detection in time is shown in Fig. \ref{fig:2l_pw_detect_prob}
...
\begin{figure}
  ...
  \caption{
    Time of arrival at the detector, probability distribution $\norm{\braDket{t}{\Phi}}_S^2$.
  }
...
Fig. \ref{fig:2l_pw_detect_prob_ft} and, again, consistent
...
%   \caption{
%     Arrival at the detector, probability distribution in the frequency domain.
%   }
%   \label{fig:2l_pw_detect_prob_ft}
% \end{figure}
...
\begin{figure}
  ...
  \caption{
    ...
    \subref{fig:2l_pw_detect_prob_omega}.
    \subref{fig:2l_pw_detect_prob_t}.
  }
  \label{fig:2l_pw_detect_prob}
\end{figure}
