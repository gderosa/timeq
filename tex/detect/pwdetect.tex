...
with the aid of \term{SymPy} within a \term{Jupyter} notebook
(see appendix \ref{detector-model-kiukas-ruschhaupt-schmidt-werner}).
...
\begin{figure}
  \centering
  \includegraphics[width=0.66\textwidth]{img/2ldetect/qubit_loss_norm.png}
  \caption{
    Non-unitary evolution of absorbed qubit: Loss of normalization.
  }
  \label{fig:absorbed-qubit-loss-norm}
\end{figure}

The evolution, with normalization loss, is shown graphically in
Figg. \ref{fig:absorbed-qubit-components} and \ref{fig:absorbed-qubit-loss-norm}.