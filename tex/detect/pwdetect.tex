...
\begin{figure} %% https://tex.stackexchange.com/a/165730
  ...
  \begin{subfigure}{0.49\textwidth}
    ...
    \caption{}\label{fig:absorbed-qubit-components:a}
  \end{subfigure}
  % \hspace*{\fill} % separation between the subfigures
  \begin{subfigure}{0.49\textwidth}
    \includegraphics[width=\linewidth]{img/2ldetect/im_psi1_t.png}
    \caption{}\label{fig:absorbed-qubit-components:b}
  \end{subfigure}
  % \hspace*{\fill} % separation between the subfigures
  \caption{
...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.49\textwidth}
    ...
    \caption{}\label{fig:absorbed-qubit-normalization-loss:a}
  \end{subfigure}
  \begin{subfigure}[b]{0.49\textwidth}
    \includegraphics[width=\linewidth]{img/2ldetect/P_omega.png}
    \caption{}\label{fig:absorbed-qubit-normalization-loss:b}
  \end{subfigure}
  \caption{
    Non-unitary evolution of absorbed qubit:
    (a) loss of normalization $-\dv{\norm{\psi}^2}{t}$ (detection probability in time);
    (b) detection probability in the frequency domain.
  }
...
\begin{figure}
  \centering
  \includegraphics[width=0.49\textwidth]{img/2ldetect/re_psi0_t_pwlattice.png}
  \includegraphics[width=0.49\textwidth]{img/2ldetect/im_psi1_t_pwlattice.png}
  \caption{
    Non-unitary ``evolution without evolution''
