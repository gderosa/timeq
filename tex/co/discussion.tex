...
TODO: quantify entanglement with Von Neumann entropy? The 
entropy used in discrete uncertainty relations (chap: PW)
is instead the
\term{R\'enyi}-\term{Shannon} entropies
\parencite[sec.{\it I}.A]{Wehner:Uncertainty}