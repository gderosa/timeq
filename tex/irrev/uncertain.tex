...
\end{equation}
with $\ket{\tilde{\phi}(\omega)}_S$ being the Fourier transform\footnote{
  Fourier transform of a (Hilber space) vector-valued function, similar to what found in \cite{Maccone:Pauli}.
}
of $\ket{\phi(t)}_S$,
