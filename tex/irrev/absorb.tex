...
\emph{and} time (in terms of outcome of an idealized measurement\footnote{
  ...
  is in position} $x \in X$, where $X$ is the region of detection,
  what is the probability density amplitude of time being $t$?
  Consistently, the Bayes rule is invoked in the following sections
  and references.
}).
