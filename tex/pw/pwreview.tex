\section{Development of the Formalism}\label{sec:pw:formalism}
...
\end{equation}
By evaluating and comparing \eqref{eq:pw:stat_eigenst_of_H_S} at two arbitrary instants of time $t_0$ and $t$,
one easily gets
