...
\end{equation*}
This is the \term{T representation}. Similarly to a ``X representation'' in standard quantum mechanics,
here $\dket{\Psi}$ is univocally identified by the ''coefficients'' $\ket{\psi(t)}_S$
