...
We will define $\Omega$ the \term{frequency operator}. One might be tempted to refer to
$E \eqbydef \hbar\Omega$ as to the ``energy operator'', however, this may lead
to confusion with the Hamiltonian $H_S$, but in fact $\hbar\Omega$ and $H_S$
act on two different Hilbert spaces ($\hilb{H}_S$ and $\hilb{H}_T$ respectively).
