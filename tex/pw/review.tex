...
$\hat{\Omega}$. Or, conversely, to identify a time operator $\hat{T}$, once $\hat{\Omega}$ is given,
and such that $[\hat{T}, \hat{\Omega}] = i$. More precisely, it is impossible to satisfy

reference weyl latest

reference \url{http://iopscience.iop.org/article/10.1088/0034-4885/67/3/R03/meta}




One problematic aspect is that
