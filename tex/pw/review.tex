...
$\hat{\Omega}$ [citation?]. However, it relies on \term{photon position} which is another
...
Another interesting aspect of the eperiment in \cite{Moreva_position} is the verification
of the \term{Legget-Garg inequalities} \parencite{LeggettGarg+PageWootters} for time measurement results.
Leggett-Garg inequalities are to $\hilb{H}_T$ what the well known Bell inequalities

TODO: Bell test of photon position
TODO: unsirprisingly no expligit hamiltonians...
