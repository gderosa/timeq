...
\begin{equation}\label{eq:canonical_commutation_in_time}
  [\op{T}, \op{\Omega}] = i
\end{equation}
cannot be both bounded, therefore cannot exist in a finite-dimensional space \parencite[\s II.11]{Weyl:GroupsQ}.
...
TODO: Weyl, uncertainty/commutator not constant. Entropy uncertainty logic not what we want\dots
Sympy.
