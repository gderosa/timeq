...
TODO: see \cite[``Fast Fourier Transform'']{NRC} for the rescaling property;
and \cite[``The Discrete Fourier Transform'' and ``Fourier Analysis etc.'']{Oppenheim:Int1,Oppenheim:Int3} for setting fundamental frequency (harmonic).
