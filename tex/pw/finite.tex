...
is not a constant.
As shown in \cite{Weyl:FiniteComm}, in an eigenbasis of q TODO Weyl page 85, second paragraph

In other words, eq. \eqref{eq:commconstant} does not longer hold.
A simple example is provided in Appendix \ref{sec:jpynb:finite-comm}.
TODO?: make it explicit here, do not rely on a SymPy notebook.
