...
$\ket{\psi_{0}(t)}_S = \E^{-\frac{i}{\hbar}t}\ket{\phi_0}_S$.
...
\end{equation*}
integrating the tensor product of eigenvectors of the two ``Hamiltonians''
$\op{H}_T$ and $\op{H}_S$ respectively in $\hilb{H}_T$ and $\hilb{H}_S$
---see also Eq. \eqref{eq:pw:time_freq_nomu}.



It is also an egienstate of $\idop_T \ox \op{H}_S$, related to the same eigenvalue:
\[
