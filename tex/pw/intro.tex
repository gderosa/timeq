...
TODO TODO TODO: redo with no explicit Fourier.
Just use $\op{H}_T \ox \idop$ and $\idop \ox \op{H}_S$
and the fat that $\dket{\Psi_0}$ \emph{must} be an eigenvector for both,
related to \emph{opposite} eigenvalues.
