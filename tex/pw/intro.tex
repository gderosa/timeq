...
An extreme case for the distribution $\ket{\phi(\omega)}_{S}$ in eq. \eqref{eq:pw:time_freq_mu}
is what in standard quantum mechanics would be the time evolution of an energy eigenstate
(an eigenstate of $\op{H}_S$ in $\hilb{H}_S$ within Page--Wootters formalism), 
related, say, to eigenvalue $E_0 \eqbydef \hbar\omega_{0}$%.
