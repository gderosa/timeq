...
meaning the global Hamiltonian $\mathbb{J}$ can be expressed as a sum of two terms
...
\begin{equation*}
  \ket{\psi(t=\tau_n)}_B \simeq \ket{\psi_n}_B \, \text{,}
\end{equation*}
where $\ket{\psi(t)}_B$ is the evolution etc. TODO
