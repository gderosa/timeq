...
As $\prescript{}{S}{\braDket{\tilde{\psi}_{0}(\omega)}{\Psi_0}}$
is the Fourier transform of $\prescript{}{S}{\bradket{\psi_0(t)}{\Psi_0}}$,
and using Eq. \eqref{eq:pw:eigenevol}, it holds:
\[
  \prescript{}{S}{\braDket{\tilde{\psi}_{0}(\omega)}{\Psi_0}}
  = \frac{1}{\sqrt{2\pi}} \int \dd{t} \E^{-iwt} \E^{i\omega_{0}t} \prescript{}{S}{\bradket{\psi_0(t)}{\Psi_0}}
