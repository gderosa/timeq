...
This notion of \term{event} is developed in \cite{MacconeGeomEvents}. See eq. 6 and the operators in eq. 1 therein.
TODO: correspondence of operators in there. Relativistic extension, connect also somewhat with our work, Ch. 5.
