...
This Section contains original additions to the results of \cite{Moreva:illustration}.
An explicit expression of the time operator $\op{T}$
is computed for the Page--Wootters clock
presented therein.
...
Finally, a discrete ``time evolution'' is obtained and compared with standard, contiuous-time
quantum mechanics.
...
is aimed at
reproducing the basic features of the Page--Wootters model
