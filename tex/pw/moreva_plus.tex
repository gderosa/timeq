\subsection{Beyond the $1+1$ qubit experiment (Was REMOVED, decide what TODO with it!)}\label{sec:beyondMoreva}
...
\begin{alignat}{5}
  % \ket{\psi\qty(-\frac{\pi}{4\omega})}_{\mathrm{PW}} \quad &\eqbydef&
