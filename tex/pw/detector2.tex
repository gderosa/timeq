\section{Comparison of PW and detector model for a two-level system}

\subsection{from 4.5 Detector models}
...
\subsection{from 4.6 Page–Wootters and detector models}
