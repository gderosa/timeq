...
$\dket{n}$'s their corresponding eigenvectors.\footnote{
  Apparent sign inconsistencies are due to different conventions adopted in the numerical code and software libraries.
}
