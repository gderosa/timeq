...
\emph{Intuitively},
one would expect the standard deviation of the time-observable probability distribution to diverge i.e.
$\sigma_T = \infty$.
...
``concentrated'' in one particular point of the ``frequency domain'': $\omega_0 = \epsilon/\hbar$.
...
a pure state in $\hilb{H}_T$. This technical difficulty must be tackled before
a more rigorous treatment of uncertainty relations can be formulated.
...
of $\pwspace$
first, as discussed in Sec.~\ref{sec:for-normalized-elements}.
