\section[% https://texfaq.org/FAQ-runheadtoobig
  One qubit universe: experimental realization and theoretical developments
]{
  One qubit universe: experimental realization and theoretical developments\sectionmark{%
    One qubit universe: exp. realiz. and theor. devel.
  }
}
\sectionmark{One qubit universe: exp. realiz. and theor. devel.}
...
\begin{figure}
  ...
  \caption[
    P-W ``evolution without evolution'' vs Schr{\"o}dinger evolution (complex values)
  ]{
    ...
    Red   line plots $\braket{0}{\psi(t)}$.
    Blue  line plots $\braket{1}{\psi(t)}$.
  }
...
(%
  ...
  for non-zero eigenvalues of $\hat{\mathbb{J}}$,
  $\epsilon \neq 0$
).
