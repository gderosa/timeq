...
numeric FFT in this case, but we do benefit of computer-aided
...
\begin{align}
  \dbraket{2k+1}{\Phi_{41}} e^{-i \epsilon_{41} t_k} &\sim \braket{0}{\psi(t_k)} \\
  \dbraket{2k+2}{\Phi_{41}} e^{-i \epsilon_{41} t_k} &\sim \braket{1}{\psi(t_k)}
  \,\text{,}
\end{align}
