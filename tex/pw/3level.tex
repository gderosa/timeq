...
\begin{figure}[h]
  ...
  \end{subfigure}
  \caption{
    Excellent overlap between
    the discrete Page--Wooters result (points)
    and
    the time evolution according to the Schr\"{o}dinger equation} (continuous lines).
\end{figure}
\begin{figure}[h]\ContinuedFloat
  ...
  \end{subfigure}
  \caption{
    Excellent overlap \textit{etc.} (continued from Fig.~\ref{fig:3lev:PWSpaceTimeFit:side}).
  }
