...
\end{quote}
Rather than spin up or down, in the present example, the arrival at level $\ket{2}$
can be derived:
\begin{equation}\label{eq:3lev:bayesPW}
  ...
  \text{,}
\end{equation}
which gives the (conditional, \term{Bayesian}) probability that, given that a detection of $\ket{2}$ happens
