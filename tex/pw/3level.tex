...
is replaced by $ K \eqbydef \hat{H} + \iu \hat{D}$, where
\begin{equation}
  \hat{D} \repr \mqty(
    0 &0 &0 \\
    0 &0 &0 \\
...
evaluated numerically at $t=180$ is given by
\begin{lstlisting}[language=Python]
...
\end{equation*}
At the ``large'' value of $t=180$ of our numerical computation, this yields
\begin{lstlisting}[language=Python]
norms_extended[-1]**2
\end{lstlisting}
\begin{lstlisting}
0.05654420595289433
\end{lstlisting}
i.e. about 5.7\% of non-absorption probabilty.
