...
\newcommand{\largeback}{\hspace{-0.300em}}

\newcommand{\dket}[1]{\largeback\left.\left| #1 \right\rangle\smallback\right\rangle}
...
\newcommand{\bradket}[2]{\largeback\left.\left\langle #1 \middle| #2 \right\rangle\smallback\right\rangle}
