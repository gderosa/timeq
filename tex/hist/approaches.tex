...
In 1974, Jerzy Kijowski \parencite{Kijowski} pursued an axiomatic approach towards a
time-of-arrival quantum distribution. Namely, the article sought to compute
the probability distribution for a particle to pass through an hypersurface
$\mathcal{Q}$ in the $3+1$-dimensional space-time. If the surface is purely
space-like, to point at which the particle passes through has space-like
