...
\iftodo
Even if time was bounded from below (Big Bang), that would not invalidate the Pauli objection.
TODO: Though, it would be worth mentioning the momentum in the half-line (Ruschhaupt)
