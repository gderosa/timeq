...
as they do in their paper,
that in the Mandelstam--Tamm derivation time has a different meaning:
...
the Page--Wootters model (1983), where a peculiar relation is in place between the clock and the system,
