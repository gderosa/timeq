...
\begin{enumerate}
  ...
  \item
    ...
    (namely Allcock, Sec. \ref{sec:allcock})
  ...
  \item
    ...
    reflaction, low absorption, and delay in the spontaneous emission are fully taken into account in the model.
    This ---although in terms of a brief illustration--- is the focus of the current Section.
\end{enumerate}
...
* Better than Halliwell there's a more realistic and explicit detector. \cite{Damborenea}

* 2-lev atoms to a laser-illuminated region, excited, then spont. emmission which is detection of arrival in the region

* still, no explicit detector/absober of the spontaneous photons; we don't detect the photon but the atom arrival in the region; the emission of the photon is the detection of the atom
