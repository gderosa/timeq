...
TODO: merge with Allcock Section. And possibly with Sec. \ref{sec:hist:detect:kiukas}.

Halliwell derivation (ref{}?) is deemd ``toy model'' in book vol. 2 sec. 4.2. Instead: \cite{Damborenea}.
More realistic (quantum optical) detector model.

\iftodo
In \cite{Damborenea} interedting observation that for t-o-a at $x=0$ we could use current
BUT theres's backflow! 
\fi
