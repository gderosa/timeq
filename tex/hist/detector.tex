...
A number of tecniques are also used to simplify the model and ultimately reduce it
to a time-independent one-dimensional problem:
the \emph{rotating wave approximation}, 
a laser-adapted \term{interacion picture}.
