...
(let's call the independent variable $t$).
...
whish thus inherits ---one may argue--- the difficulties connected to
...
and one may operate an an inessential change of notation
and then wonder why
in the identity
