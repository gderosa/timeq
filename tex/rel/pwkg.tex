...
$\Psi$ is not normalizable i.e. it is not a proper element of
...
It is tempting to name the \eqref{eq:pwkg} and \eqref{eq:p0123} the \term{Page--Wootters-Klein-Gordon}
equation.\footnote{
...
Looking back at Table \ref{tbl:op_comparison_pw}, it can thus be extended as:
{
  \begin{table}[h!]
    \centering
    \begin{tabular}{p{0.3\linewidth}||c|c|c}
      ...
      \hline
      \hline
        {\footnotesize Space--time ``positions''}                           &
        $\hat{t}$                                                               &
        $\hat{x}$                                                               &
                                                                                \\
      \hline
