...
(\cite{Greiner_Rel}, \cite[\ch 8]{Sakurai2}, \cite{DiracEquation}, \cite[\citeplace{handout} 2]{Webber_notes}).
...
As anticipated, this resolves the asymmetry in Table \ref{tbl:op_comparison_pw},
...
TODO: Table \ref{tbl:op_comparison_pw} has been updated so you should adapt this too:
``asymmetry'' there was just removed/hidden as ``requested''\dots
Maybe just say that this ``extends''/(``generalize''?)
Table \ref{tbl:op_comparison_pw} with some interesting/new symmetries\dots