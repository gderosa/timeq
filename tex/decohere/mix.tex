...
% Nielsen and Chuang at excercise  2.71 but not the excercise itself but
% but the example that follows.
%
% Theorem 2.6. is a better reference: you can mention it without proof,
% for which just reference the reference :)
