...
Conversely,
the ket $\ket{\mu}$, when acting on an element of $\hilb{H}_{A} \ox \hilb{H}_{B}$,
can be defined
as a map from $\hilb{H}_A\otimes\hilb{H}_B$ to a bra in $\hilb{H}_A$.
The following definition is simply ``dual'' to Definition \ref{def:pBra}
